...
export default function Category({ loaderData }: Route.ComponentProps) {
    ...
    return (
        <>
            ...
            <QuickMenuContents>
                <section className="poj2-category-home grid grid-cols-1 min-lg:grid-cols-[180px_calc(100%-200px)] gap-4 lg:gap-5 lg:mb-15 mb-30">
                    <div className="sticky top-0 h-fit hidden min-lg:flex flex-col gap-4 lg:gap-5 sm:pt-5">
                        <CategoryMenu />
