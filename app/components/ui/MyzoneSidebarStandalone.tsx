...
const defaultMenuItems = [
    {
        ...
        items: [
            {
                icon: (
                    <svg viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg" className="block lg:hidden w-5 h-5 fill-current">
                        <path
                            fillRule="evenodd"
                            clipRule="evenodd"
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                label: "나의 문의내역",
                href: "/customer-center/inquiry-history",
                chevron: true
            }
        ]
    }
...
const ChevronRightIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" className="block lg:hidden w-6 h-6 fill-current">
...
export default function MyzoneSidebarStandalone({
        ...
        <nav className="px-4 max-lg:py-4 max-lg:divide-y max-lg:divide-border">
            {showTitle && (
                <h2 className="hidden lg:block text-4xl py-10">
                    <a 
                        href={titleHref} 
                        onClick={(e) => handleLinkClick(titleHref, titleText, e)}
                        data-discover="true"
                    >
                        {titleText}
                    </a>
            ...
            {menuItems.map((section, sectionIndex) => (
                <div key={section.title} className={sectionIndex === 0 ? '' : 'pt-8 lg:pt-2'}>
                    <h3 className="max-lg:mb-2 text-lg font-bold">{section.title}</h3>
